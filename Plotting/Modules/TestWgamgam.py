...
def config_samples(samples) :
    ...
    samples.AddSample('ZggFSR'                       , path='job_summer12_Zg'             ,  isActive=False, useXSFile=True, XSName='Zg' )
    #samples.AddSample('ZggFSR'                        , path='job_summer12_ZgDiPhoton3'              ,  isActive=False, useXSFile=True, XSName='Zg' )
