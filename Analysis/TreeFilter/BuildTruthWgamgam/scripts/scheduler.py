...
p.add_argument( '--batch', dest='batch', default=False, action='store_true', help='Run locally, not on batch' )
options = p.parse_args()

if not options.run and not options.check :
    options.run = True

base = '/eos/cms/store/user/jkunkle/Wgamgam/TTTruth_2016_01_21'
#base = '/afs/cern.ch/work/j/jkunkle/private/CMS/Wgamgam/Output/TTTruth_2016_01_21/'
...
top_configs = [ 
                { 
                  'module'      : 'ConfXSFilter.py',
                  'output_name' : 'TTTruthFilterNoTrig_2016_01_21',
                  'tag'         : 'truth',
                },
]
