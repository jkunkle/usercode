...
configs = [ 
    ...
    #    'input'  : input_base,
    #    'output' : base+'SingleLepNoPhID_el_2017_04_12',
    ...
    #    'input'  : input_base,
    #    'output' : base+'SingleLepNoPhID_mu_2017_04_12',
    #    'dataset': 'SingleMuon',
    #    'tag'    : 'mu',
    #},
    #{
    ...
    #},
    {
        ...
        'input'  : input_base,
        'output' : base+'LepGamma_mug_2017_04_17',
        'tag'    : 'mug',
        'dataset': 'SingleMuon',
    },
    {
        ...
        'input'  : input_base,
        'output' : base+'LepGamma_elg_2017_04_17',
        'tag'    : 'elg',
        'dataset': 'SingleElectron',
    },
    #{
    ...
    #{
    #    'module' : 'Conf.py',
    #    'args'   : { 'function' : 'make_final_mug', 'mu_pt' : ' > 10 ', 'el_pt' : ' > 10 ' , 'ph_pt' : ' > 15 ', 'phot_vars' : 'True', 'phot_id' : 'loose' },
    #    'input'  : input_base,
    #    'output' : base+'LepGamma_mug_looseph_2017_03_14',
    #    'tag'    : 'muglph',
    #},
    #{
    #    'module' : 'Conf.py',
    #    'args'   : { 'function' : 'make_final_elg', 'mu_pt' : ' > 10 ', 'el_pt' : ' > 10 ' , 'ph_pt' : ' > 15 ', 'phot_vars' : 'True', 'phot_id' : 'loose' },
    #    'input'  : input_base,
    #    'output' : base+'LepGamma_elg_looseph_2017_03_14',
    #    'tag'    : 'elglph',
    #},
    #{
    #    'module' : 'Conf.py',
    ...
    #    'input'  : input_base,
    #    'output' : base+'SigPassLepton_2017_04_12',
    #    'tag'    : 'nofilt',
    #},
    ##{
    ##    'module' : 'Conf.py',
