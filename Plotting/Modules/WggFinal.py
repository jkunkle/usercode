...
def config_samples(samples) :
    ...
    samples.AddSample('WAAQGCLT'      , path='WggAQGCLT50'   ,legend_name='W#gamma#gamma, LT0 = 50 TeV^{-4}'      ,isActive=False, plotColor=ROOT.kMagenta+2, required=False, useXSFile=True, isSignal=True )
    ...
    samples.AddSampleGroup('AllBkgPlusQGC' , legend_name = 'Expected, LT0 = 50 TeV^{-4}' ,input_samples = ['Zgg', 'OtherDiPhoton', 'EleFake', 'JetFake', 'WAAQGCLT'], isActive=False, isSignal=True, plotColor=ROOT.kMagenta+2)
