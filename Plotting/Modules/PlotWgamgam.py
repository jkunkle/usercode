...
def config_samples(samples) :
    ...
    samples.AddSample('WAA_ISR'                  , path='job_NLO_WAA_ISRWithSF'                   ,  isActive=False, required=False, useXSFile=True, XSName='NLO_WAA_ISR' )
    samples.AddSample('WAA_FSR'                  , path='job_NLO_WAA_FSRWithSF'                   ,  isActive=False, required=False, useXSFile=True, XSName='NLO_WAA_FSR' )
