...
#python scripts/filter.py --files ../RecoPhoton15/TEST/Job_0000/hltbits.root --treeName HltTree --module scripts/ConfTemplate.py --outputDir TEST --enableRemoveFilter  
