...
jobs_mc = [
        ...
        JobConf(base, base_orig, 'job_summer12_WZ_2l2q'),
        JobConf(base, base_orig, 'job_summer12_WZ_3lnu'),
...
top_configs = [
    ...
    # 'input_name'  : 'LepGammaGammaFinalElPSVOldWindowUnblindAll_2015_12_11',
    # 'output_tag'  : 'WithSF',
    # 'tag'         : 'elFinalSF'
    #},
    #{   
    ...
    {   
     'module'      : 'Conf.py', 
     'args'        : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
     'input_name'  : 'LepLepGammaGammaFinalMuMuUnblindAll_2015_12_12',
     'output_tag'  : 'WithSF',
     'tag'         : 'mumuFinalSF'
    },
    {   
     'module'      : 'Conf.py', 
     'args'        : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
     'input_name'  : 'LepLepGammaGammaFinalElElUnblindAll_2015_12_12',
     'output_tag'  : 'WithSF',
     'tag'         : 'elelFinalSF'
    },
    #{   
    # 'module'      : 'Conf.py', 
    # 'args'        : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    # 'input_name'  : 'LepGammaGammaFinalMuUnblindAllNoMtCutPt15_2015_11_11',
    # 'output_tag'  : 'WithSF',
    # 'tag'         : 'muFinalSF'
    #},
    #{   
    # 'module'      : 'Conf.py', 
    # 'args'        : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    # 'input_name'  : 'LepGammaGammaFinalElCSEVUnblindAllNoZCutNoMtCut_2015_11_11',
    # 'output_tag'  : 'WithSF',
    # 'tag'         : 'elFinalSF'
    #},
    {   
     'module'      : 'Conf.py', 
     'args'        : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
     'input_name'  : 'LepGammaGammaFinalMuUnblindAllNoMtCut_2015_11_11',
     'output_tag'  : 'WithSF',
     'tag'         : 'muFinalSF'
    },
    {   
     'module'      : 'Conf.py', 
     'args'        : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
     'input_name'  : 'LepGammaGammaFinalElUnblindAllNoZCutNoMtCut_2015_11_11',
     'output_tag'  : 'WithSF',
     'tag'         : 'elFinalSF'
    },
    ...
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuEGammaEScaleDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuEGammaEScaleUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMETEMScaleDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMETEMScaleUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMETJERDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMETJERUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMETJESDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMETJESUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMETMuonScaleDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMETMuonScaleUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMETUnClusDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMETUnClusUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMuonScaleDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuMuonScaleUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaMuNOMINALFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElEGammaEScaleDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElEGammaEScaleUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElMETEMScaleDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElMETEMScaleUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElMETJERDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElMETJERUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElMETJESDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElMETJESUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElMETMuonScaleDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElMETMuonScaleUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElMETUnClusDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepGammaGammaElMETUnClusUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepLepGammaGammaElEGammaEScaleDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepLepGammaGammaElEGammaEScaleUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepLepGammaGammaElNOMINALFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepLepGammaGammaMuEGammaEScaleDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepLepGammaGammaMuEGammaEScaleUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepLepGammaGammaMuMuonScaleDNFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepLepGammaGammaMuMuonScaleUPFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
    #{
    #  'module'     : 'Conf.py',
    #    'args'     : {'functions' : 'get_muon_sf,get_electron_sf,get_photon_sf,get_pileup_sf' },
    #    'input_name' : 'LepLepGammaGammaMuNOMINALFinal_2015_12_09', 
    #    'output_tag' : 'WithSF',
    #    'tag'       : 'muFinalSF',
    #},
