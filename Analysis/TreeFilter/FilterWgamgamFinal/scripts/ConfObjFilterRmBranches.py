...
def get_remove_filter() :
    ...
    return ['el_mva_trig', 'el_mva_nontrig', 'el_d0pv', 'el_z0pv', 'el_sigmaIEIE',
           ...
           'pfType01METmEtSig',
           'pfMETmEtSig',
           'ph_passChIsoCorrTight',
           'recoPfMETsumEt',
           'pfType01METsumEt',
           'pfMETsumEt',
           'ph_passPhoIsoCorrTight',
           'el_passVeryLoose',
           'el_passMvaTrigNoIso',
           'ph_passChIsoCorrLoose',
           'jet_PUIDTight',
           'jet_PUIDMedium',
           'jet_PUIDLoose',
           'ph_passSIEIETight',
           'ph_passPhoIsoCorrLoose',
           'el_passMvaTrigOnlyIso',
           'ph_passSIEIELoose',
           'el_hasMatchedConv',
           'el_passMvaNonTrigNoIso',
           'ph_passNeuIsoCorrTight',
           'el_passMvaNonTrigOnlyIso',
           'el_truthMatch_el',
           'el_truthMatchPt_el',
           'el_truthMinDR_el',
           'ph_passHOverELoose',
           'ph_passHOverETight',
           'ph_passNeuIsoCorrLoose',
           'ph_truthMatchParentage_ph',
           'ph_truthMatchPt_el',
           'ph_truthMatchPt_ph',
           'ph_truthMinDR_el',
           'ph_truthMinDR_ph',
