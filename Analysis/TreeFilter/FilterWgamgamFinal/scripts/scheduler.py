...
top_configs = [ 
                ...
                #  'output_name' : 'LepGammaGammaNoPhIDNoTrigElOlapRmTEST_2016_02_29',
                #  'tag'         : 'lgg',
                #},
                { 
                  'module'      : 'ConfObjFilterRmBranches.py',
                  ...
                  'output_name' : 'LepGammaMediumPhIDNoTrigOlapRmRmBranches_2016_07_19',
                  'tag'         : 'lg',
                },
                #{ 
                #  'module'      : 'ConfObjFilter.py',
                #  'args_mc'     : '{ \'cut_nLepTrigMatch\' : \' > 0 \', \'cut_nPh\' : \'> 0\', \'cut_SingleLepTrig\' : \' == True \', \'cut_nNotOverlap\' : \' > 0 \' }',
                #  'args_data'   : '{ \'cut_nLepTrigMatch\' : \' > 0 \', \'cut_nPh\' : \'> 0\', \'cut_SingleLepTrig\' : \' == True \', \'cut_nNotOverlap\' : \' > 0 \', \'isData\' : \' == True\' }',
                #  'output_name' : 'LepGammaMediumPhIDNoTrigOlapRmTEST_2016_05_11',
                #  'tag'         : 'lg',
                #},
                #{ 
                #  'module'      : 'ConfObjFilterTrigElOlap.py',
                #  'args_mc'     : '{ \'cut_nLepTrigMatch\' : \' > 0 \', \'cut_nPh\' : \'> 0\', \'cut_SingleLepTrig\' : \' == True \', \'cut_nNotOverlap\' : \' > 0 \' }',
                #  'args_data'   : '{ \'cut_nLepTrigMatch\' : \' > 0 \', \'cut_nPh\' : \'> 0\', \'cut_SingleLepTrig\' : \' == True \', \'cut_nNotOverlap\' : \' > 0 \', \'isData\' : \' == True\' }',
                #  'output_name' : 'LepGammaMediumPhIDTrigElOlapRm_2016_05_11',
                #  'tag'         : 'lgTo',
                #},
                #{ 
                #  'module'      : 'ConfObjFilterFullElElOlap.py',
                #  'args_mc'     : '{ \'cut_nLepTrigMatch\' : \' > 0 \', \'cut_nPh\' : \'> 0\', \'cut_SingleLepTrig\' : \' == True \', \'cut_nNotOverlap\' : \' > 0 \' }',
                #  'args_data'   : '{ \'cut_nLepTrigMatch\' : \' > 0 \', \'cut_nPh\' : \'> 0\', \'cut_SingleLepTrig\' : \' == True \', \'cut_nNotOverlap\' : \' > 0 \', \'isData\' : \' == True\' }',
                #  'output_name' : 'LepGammaMediumPhIDFullElOlapRm_2016_05_11',
                #  'tag'         : 'lgTo',
                #},
                #{ 
                #  'module'      : 'ConfObjFilter.py',
                ...
                #  'output_name' : 'LepGammaMediumPhIDNoTrigElOlapRm_2016_02_29',
                #  'tag'         : 'lgm',
                #},
                #{ 
                #  'module'      : 'ConfObjFilter.py',
